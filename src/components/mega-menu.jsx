    ...
    return (
        <>
            ...
            >
                ...
                <div
                    onMouseEnter={() => setExpandedId(id)}
                    className={`fixed top-0 left-0 w-full bg-white/85 dark:bg-darkColor/85 transition-all duration-450 ease-[cubic-bezier(0.25, 0.1, 0.25, 1)] overflow-hidden border-b border-b-neutral-600/20 dark:border-neutral-300/20
                             ${isExpanded
