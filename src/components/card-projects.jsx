                        ...
                        >
                            ...
                            >
                                <div className="w-full max-h-80 h-80 rounded-lg overflow-hidden relative group">
                                    ...
                                    />
                                    <div className="absolute top-0 left-0 dark:bg-black bg-white text-orange-400 px-3 py-1 rounded-br-lg text-sm font-medium ">
                                ...
                                <div className="pt-3 space-y-3">
                                    <h1 className="font-semibold text-xl group-hover:text-orange-400 duration-300">
                                        {el.title}
                                    </h1>
